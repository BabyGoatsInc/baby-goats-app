-- Baby Goats Database Schema - FIXED VERSION
...
-- 5. Challenge completions table (FIXED VERSION)
...
-- Create unique index to prevent duplicate completions per day (FIXED APPROACH)
