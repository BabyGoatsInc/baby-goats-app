-- ====================================================================
-- BABY GOATS FIXED SOCIAL SCHEMA FOR SUPABASE
-- ====================================================================
-- This version fixes the RLS policy issues and ensures all tables are created
...
-- ====================================================================
-- 1. CORE PROFILES TABLE (Fixed Reference)
-- ====================================================================

-- Update existing profiles table to ensure compatibility
...
-- Messages Table (Live Chat & Messaging)
...
-- ====================================================================
-- 3. LEADERBOARDS AND POINTS SYSTEM
-- ====================================================================
...
-- Team Challenge Participations Table
...
-- Team Challenge Contributions Table
...
-- Team Competition Registrations Table
...
-- ====================================================================
-- 7. SAMPLE DATA (Essential for Testing)
-- ====================================================================
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '⚠️  WARNING: Only % out of 14 tables were created', table_count;
